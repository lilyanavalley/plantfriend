...
pub struct Config {
    ...
    pub ha: HaConfig,
    pub ota: OtaConfig,
    pub runtime: RuntimeSensorContract,
}
...
impl Config {
    ...
    pub fn load() -> Self {
        ...
        Config {
            wifi: WifiConfig {
                ssid: GEN_WIFI_SSID,
                password: GEN_WIFI_PASSWORD,
            },
            mqtt: MqttConfig {
                broker_uri: GEN_MQTT_BROKER_URI,
                username: GEN_MQTT_USERNAME,
                password: GEN_MQTT_PASSWORD,
                client_id: GEN_MQTT_CLIENT_ID,
                tls,
            },
            sensor: SensorConfig {
            ...
            publish: PublishConfig {
                interval_ms: GEN_PUBLISH_INTERVAL_MS,
            },
            ha: HaConfig {
                discovery_prefix: GEN_HA_DISCOVERY_PREFIX,
                device_id: GEN_HA_DEVICE_ID,
                device_name: GEN_HA_DEVICE_NAME,
                state_topic: GEN_MQTT_STATE_TOPIC,
                availability_topic: GEN_MQTT_AVAILABILITY_TOPIC,
            },
            ota: OtaConfig {
